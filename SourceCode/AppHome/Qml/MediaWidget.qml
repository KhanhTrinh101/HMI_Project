...
MouseArea {
    ...
    Image {
        ...
        source: {
            if (myModel.rowCount() > 0 && myModel.rowCount() >  player.playlist.currentIndex)
                ...
                return "qrc:/Img/App/Media/album_art.png"
        }
    }
    FastBlur {
        anchors.fill: bgBlur
    ...
    Text {
        ...
        y: 40
        text: qsTr("STR_USB_MUSIC") + Translator.updateText
        color: "white"
        font.pixelSize: 34
    }
    Image {
    ...
    Image{
        ...
        width: 258
        height: 258
        source: "qrc:/Img/HomeScreen/MediaWidget/widget_media_album_bg.png"
    }
    Text {
        id: txtSinger
        x: 42
    ...
    Image{
        ...
        y: (56+343+55+62)
        width: 511
        source: "qrc:/Img/HomeScreen/MediaWidget/widget_media_pg_n.png"
    }
    Image{
        id: imgPosition
        x: 62
        y: (56+343+55+62)
        width: 0
        source: "qrc:/Img/HomeScreen/MediaWidget/widget_media_pg_s.png"
    }
